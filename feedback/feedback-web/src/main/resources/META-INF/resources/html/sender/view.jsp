...
<%@page import="it.smc.liferay.feedback.permission.ManagerPermissionUtil"%>
<%@page import="it.smc.liferay.feedback.enums.ActionKeys"%>
...
boolean canAdd = ManagerPermissionUtil.containsTopLevel(permissionChecker, scopeGroupId, ActionKeys.ADD_FEEDBACK);
