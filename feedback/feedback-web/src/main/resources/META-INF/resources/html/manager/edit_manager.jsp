...
boolean canUpdate = ManagerPermissionUtil.containsTopLevel(permissionChecker, groupId, ActionKeys.UPDATE);
boolean canDelete = ManagerPermissionUtil.contains(permissionChecker, groupId, ActionKeys.DELETE);
%>

<portlet:actionURL name="updateManager" var="updateManagerURL">
	<portlet:param name="jspPage" value="/manager/edit_manager.jsp" />
