...
/**
 * The implementation of the manager local service.
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the {@link it.smc.liferay.feedback.service.ManagerLocalService} interface.
 *
 * <p>
 ...
 *
 * @author dbg
 * @see ManagerLocalServiceBaseImpl
...
public class ManagerLocalServiceImpl extends ManagerLocalServiceBaseImpl {
	...
	public Manager addManager(
		...
		managerPersistence.update(manager);
	...
	public Manager updateManager(
		...
		manager = managerPersistence.update(manager);
